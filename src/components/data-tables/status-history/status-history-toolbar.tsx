...
interface StatusHistoryToolbarProps<TData> {
...
export function StatusHistoryToolbar<TData>({
  table,
}: StatusHistoryToolbarProps<TData>) {
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 items-center space-x-2">
        <Input
          placeholder="Setor, secretaria ou responsável..."
        ...
        {isFiltered && (
          <Button
            ...
            onClick={() => {
              ...
              table.getColumn('Secretaria')?.setFilterValue('')
            }}
